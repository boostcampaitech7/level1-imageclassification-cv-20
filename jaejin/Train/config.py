class Config:
    # 데이터 관련
    TRAIN_DATA_DIR = "/data/ephemeral/home/cv20-proj1/level1-imageclassification-cv-20/data/train"
    TEST_DATA_DIR = '/data/ephemeral/home/cv20-proj1/level1-imageclassification-cv-20/data/test'
    ...
    # 로깅 및 체크포인트
    CHECKPOINT_DIR = f"./train_result/{MODEL_NAME}_{LEARNING_RATE}"
    ...
    # 추론 관련
    INFERENCE_MODEL_PATH = "./train_result/best_model.pth"
    RESULT_DIR = "./output"
